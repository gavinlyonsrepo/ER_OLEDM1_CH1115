...
So to use a non-default Font (2-8), two steps.Comment in the respective define at top of library header file ER_OLEDM1_CH1115_font.hpp in the USER FONT OPTION ONE section.
Call SetFontNum function and pass it enum label of respective font.  
...
Simply comment this define out. UC_FONT_MOD_TWO (save 640 bytes) extended ASCII 127-255
